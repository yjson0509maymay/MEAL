...
def build_html(meal_data, sheet_url, extra_data=None):
    ...
    if MEAL_FORM_EMBED_URL:
        ...
        my_meal_btn = f'''<div style="display:flex;gap:6px">
      <div onclick="toggleMealForm()"
       style="flex:1;min-width:0;display:flex;align-items:center;justify-content:center;text-align:center;
              gap:5px;background:#fff;color:var(--primary);
              border:1.5px solid var(--primary);border-radius:999px;padding:9px 6px;font-size:11.5px;
      ...
      <a href="{form_response_url}" target="_blank"
         style="flex:1;min-width:0;display:flex;align-items:center;justify-content:center;text-align:center;
                gap:5px;background:#fff;color:var(--ink-soft);
                border:1.5px solid var(--line);border-radius:999px;padding:9px 6px;font-size:11.5px;
